...
public class DoubleLinkedLists08 {
    ...
    public void add(Faksinasi08 item, int index) throws Exception {
        if (isEmpty()) {
            addFirst(item);
    ...
    public Faksinasi08 getFirst() throws Exception {
        if (isEmpty()) {
    ...
    public Faksinasi08 getLast() throws Exception {
        if (isEmpty()) {
            throw new Exception("Linked List kosong");
        }
        Node08 tmp = head;
    ...
    public Faksinasi08 get(int index) throws Exception {
        if (isEmpty() || index >= size) {
            throw new Exception("Nilai indeks di luar batas.");
        }
        Node08 tmp = head;
